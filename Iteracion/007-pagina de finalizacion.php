  ...
  <body>
    ...
    <main>
      ...
      ?>
        ...
        ?>
          <!-- DETALLE (equivalente a producto) -->
          <section class="campo">
            <div class="izquierda">
              <img src="img/campo.png">
              <a href="?operacion=finalizar&campo=1">📌 Reservar</a>
            </div>
        ...
        <?php }else if($_GET['operacion'] == "finalizar"){ ?>

          <!-- FINALIZACIÓN -->
          <section class="finalizacion">
            Ya estás en la página de finalización
          </section>
